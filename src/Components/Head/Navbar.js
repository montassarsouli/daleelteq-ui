...
const Navbar = () => {
  ...
  const solutionsDropdown = [
    {
      navs: [
        {
          title: `${t("Mails & documents management")}`,
          desc: `${t("")}`,
  ...
  const navigation = [
    {
      ...
      path: "javascript:void(0)",
      isDrapdown: true,
      navs: solutionsDropdown,
    },
    {
      title: `${t("Services")}`,
      path: "javascript:void(0)",
      isDrapdown: true,
      navs: servicesDropdown,
    },
    {
      title: `${t("About Us")}`,
      path: "javascript",
    ...
    { title: `${t("Contact Us")}`, path: "#contact", isDrapdown: false },
  ];
  useEffect(() => {
    document.onclick = (e) => {
  ...
  return (
    <>
      ...
      >
        <div className="items-center gap-16 max-w-screen-xl md:flex">
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <a href="javascript:void(0)">
              <img src={img01} width={120} height={80} alt="Daleelteq-logo" />
            </a>
          ...
          >
            <ul className="items-center space-y-6 md:flex md:gap-4 md:space-y-0">
